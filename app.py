...
st.markdown(
    ...
    <style>
        ...
        .priority-high { color: #991b1b; font-weight: 650; }
        .priority-medium { color: #92400e; font-weight: 650; }
        .priority-low { color: #374151; font-weight: 650; }
...
def analyze_resume(resume_text, job_description):
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "because it would be useful for the job. You distinguish "
            "matched evidence, partial evidence, and information that is "
...
7. Be specific when describing resume evidence.
...
"""
    ...
    try:
        ...
        if "timeout" in error_text.lower():
            raise RuntimeError(
                "The AI request timed out. Please try again with shorter inputs."
            )
...
st.markdown(
    ...
    <div class="app-header">
        ...
        <div class="app-subtitle">Resume Review and Job Matching</div>
...
if result:
    ...
    if requirements:
        for index, requirement in enumerate(requirements, start=1):
            ...
            importance = requirement.get("importance", "Not specified")
            status = requirement.get("status", "not_mentioned")
            ...
            with st.container(border=True):
                ...
                st.markdown(f"**Resume evidence:** {evidence}")

                if explanation:
                    st.markdown(f"**Analysis:** {explanation}")
    else:
        st.info("No requirement-level analysis was returned.")
    ...
    with col1:
        ...
        supported = ats.get("supported_keywords", [])
    ...
    with col2:
        ...
        structure = ats.get("structure_issues", [])
        ...
        readability = ats.get("readability_issues", [])
    ...
    if recommendations:
        for recommendation in recommendations:
            ...
            honest_action = recommendation.get("honest_action", "")
        ...
        st.caption("No improvement recommendations were generated.")
    ...
    if interview_questions:
        ...
        st.caption("No interview questions were generated.")
